...
# --- load data---
training_data                <- read.csv("HPP_train/predict_decay/training.csv",
...
save(model, file = "HPP_train/predict_decay/model.RData")
...
write.csv(model_p, "HPP_train/predict_decay/model_parameters.csv")
