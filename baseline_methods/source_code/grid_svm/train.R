# A function for training an ANN model using grid-search. Should run from autom_experiments
...
train = function(dataset, file_name) {
  ...
  opt_parameters <- expand.grid( C = seq(0,5, 0.1),
                                 sigma = seq(0,1, 0.05))
  ...
  model_path = paste(file_name, "grid_svm.RData", sep ="/")  
